					...
					<div class="row">	
						<div class="col-sm-12 text-center">
							...
							<ul class="list-inline center-block">
								...
								<li><a href="#"><img src="{{asset('frontend')}}/images/card-3.png"></a></li>
								<li><a href="#"><img src="{{asset('frontend')}}/images/card-4.png"></a></li>
								<li><a href="#"><img src="{{asset('frontend')}}/images/card-5.png"></a></li>
							</ul>
						</div>
					</div>
				</div>	
